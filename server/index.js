...
// Connect to MongoDB
mongoose.connect('mongodb://localhost:27017/tasknetreact', { useNewUrlParser: true, useUnifiedTopology: true })
...
app.post('/api/signup', async (req, res) => {
  ...
  try {
    ...
    console.log('User created, token generated:', token);  // Log token generation
